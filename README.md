...
+ Chức năng Thử dáng, chọn size dựa trên các chỉ số cơ thể (chiều cao, cân nặng, vòng eo,..)
...
# 8. Thử dáng chọn size theo chỉ số cơ thể

**Tác nhân**:
**Mô tả**: Cho phép người dùng nhập các chỉ số cơ thể để lựa chọn size đồ phù hợp 

**Luồng chính**:
1. Tác nhân truy cập vào Trang danh sách sản phẩm và lựa chọn mục "Thử dáng với thương hiệu này"
2. Hệ thống hiển thị form các chỉ số cơ thể
3. Tác nhân điền đúng thông tin và tiến hành kiểm tra
4. Hệ thống hiển thị kết quả 
    a. Nếu kết quả phù hợp, hiển thị size phù hợp và size vừa nhất với dáng người
    b. Nếu kết quả không phù hợp, hiển thị "Không có kết quả phù hợp"
...
git clone https://github.com/ThaoYen43/TMU-fashion-review_NHOM06
